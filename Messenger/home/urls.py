...
from .views import HomePageView, MyPostsView, DeletePostView, UpdatePostView, UpdatePrifileView
...
urlpatterns = [
    ...
    # path("load_image/", view = LoadImageView.as_view(), name = 'load_image'),
    path("edit-profile/<int:pk>", view = UpdatePrifileView.as_view(), name = 'edit-profile'),
]